...
$arrayofmassactions = array(
	...
	'premakemailing' => img_picto('', 'envelope', 'class="pictofixedwidth"').$langs->trans("CreateMailing"),
	'preaddmailing' => img_picto('', 'envelope-open', 'class="pictofixedwidth"').$langs->trans("ListOfEMailings"),
);
if (!empty($permissiontodelete)) {
	$arrayofmassactions['predelete'] = img_picto('', 'delete', 'class="pictofixedwidth"').$langs->trans("Delete");
}
if (GETPOSTINT('nomassaction') || in_array($massaction, array('presend', 'preaddmailing', 'premakemailing', 'predelete'))) {
	$arrayofmassactions = array();
}
